...
try:
    ...
    print("Welcome to our Time Analysis Programme\n")
    ...
    if choice == 'e':
        ...
        if how_much_time_before_last_time_done_programming_seconds > 172800:
            ...
            with open("reasons.md", 'a')as re:
                re.write(
                    f"|{Last_time_ended_programming_date} {Last_time_ended_programming_time}|{Proper_Date} {Time}|{how_much_time_before_last_time_done_programming}|{reason}|\n")
                exit()
