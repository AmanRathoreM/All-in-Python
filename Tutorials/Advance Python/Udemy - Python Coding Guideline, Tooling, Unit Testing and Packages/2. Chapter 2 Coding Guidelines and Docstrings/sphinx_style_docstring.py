...
class Employee:
    ...
    def __init__(self,  name="Unknown", salary=0.0, number_of_leaves=0):
        ...
        :param name: Enter the name of the employee here, defaults to "Unknown"
        :type name: str, optional
        :param salary: Enter the salary of the employee here, defaults to 0.0
        :type salary: float, optional
        :param number_of_leaves: Enter the number of leaves taken by the employee here, defaults to 0
        :type number_of_leaves: int, optional
        :raises Warning: If salary is not a float
