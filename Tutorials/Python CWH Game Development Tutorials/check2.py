...
def game_loop():
    ...
    background_image_location_for_game_over = "tutorial 21[game over sad snake].jpg"
    fps = 20
    ...
    snake_food_size_x = 30
    snake_food_size_y = 30
    ...
    if snake_food_position_x > screen_width:
        ...
        snake_food_position_y -= screen_height
    how_much_away_snake_will_be_to_have_food = 20
    ...
    while not game_exit:
        if game_over == False:
            ...
            if snake_position_x < 0 or snake_position_x > screen_width or snake_position_y < 0 or snake_position_y > screen_height:
                ...
                pg.mixer.music.play()
                game_window.blit(
                    # background_image_for_game_over_terminal, (0, 0))
                game_over=True
